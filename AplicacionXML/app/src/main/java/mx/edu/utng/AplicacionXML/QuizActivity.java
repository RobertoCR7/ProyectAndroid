...
//-------------------------------------guardado----------------------------------------------------------------
                    int idModulo= dbAdapter.idModulo1(LoginActivity.ID_USUARIO,"Modulo_1");
                    ...
                    Toast.makeText(QuizActivity.this, "Calificacion: "+calif, Toast.LENGTH_SHORT).show();
                    switch (valoresRecibidos.getInt("modulo")){
                        case 0://------ Temas
                            switch (valoresRecibidos.getInt("tema")){

                                case 0:
                                    dbAdapter.addCalifTemas(idModulo, 1, 1, score);
                        ...
                        case 1:
                            switch (valoresRecibidos.getInt("tema")){
                                case 0:
                                    dbAdapter.addCalifTemas(idModulo, 2, 1, score);

                                    break;
                                case 1:
                                    dbAdapter.addCalifTemas(idModulo, 2, 2, score);


                                    break;
                                case 2:
                                    dbAdapter.addCalifTemas( idModulo, 2, 3, score);

                                    break;
                                case 3:
                                    dbAdapter.addCalifTemas(idModulo, 2, 4, score);

                                    break;
                                case 4:
                                    dbAdapter.addCalifTemas(idModulo, 2, 5, score);
                        ...
                        case 2:
                            switch (valoresRecibidos.getInt("tema")){
                                case 0:
                                    dbAdapter.addCalifTemas(idModulo, 3, 1, score);

                                    break;
                                case 1:
                                    dbAdapter.addCalifTemas(idModulo, 3, 2, score);

                                    break;
                                case 2:
                                    dbAdapter.addCalifTemas(idModulo, 3, 3, score);

                                    break;
                                case 3:
                                    dbAdapter.addCalifTemas( idModulo, 3, 4, score);

                                    break;
                                case 4:
                                    dbAdapter.addCalifTemas(idModulo, 3, 5, score);

                                    break;
                                case 5:
                                    dbAdapter.addCalifTemas( idModulo, 3, 6, score);

                                    break;
                                case 6:
                                    dbAdapter.addCalifTemas( idModulo, 3, 7, score);

                                    break;
                                case 7:
                                    dbAdapter.addCalifTemas(idModulo, 3, 8, score);
                        ...
                        case 3:
                            switch (valoresRecibidos.getInt("tema")){
                                case 0:
                                    dbAdapter.addCalifTemas(idModulo, 4, 1, score);

                                    break;
                                case 1:
                                    dbAdapter.addCalifTemas(idModulo, 4, 2, score);


                                    break;
                                case 2:
                                    dbAdapter.addCalifTemas(idModulo, 4, 3, score);


                                    break;
                                case 3:
                                    dbAdapter.addCalifTemas(idModulo, 4, 4, score);


                                    break;
                                case 4:
                                    dbAdapter.addCalifTemas( idModulo, 4, 5, score);

                                    break;
                                case 5:
                                    dbAdapter.addCalifTemas(idModulo, 4, 6, score);

                                    break;
                                case 6:
                                    dbAdapter.addCalifTemas(idModulo, 4, 7, score);
                        ...
                        case 4:
                            switch (valoresRecibidos.getInt("tema")){
                                case 0:
                                    dbAdapter.addCalifTemas(idModulo, 5, 1, score);

                                    break;
                                case 1:
                                    dbAdapter.addCalifTemas(idModulo, 5, 2, score);

                                    break;
                                case 2:
                                    dbAdapter.addCalifTemas(idModulo, 5, 3, score);

                                    break;
                                case 3:
                                    dbAdapter.addCalifTemas(idModulo, 5, 4, score);

                                    break;
                                case 4:
                                    dbAdapter.addCalifTemas( idModulo, 5, 5, score);//asta hay

                                    break;
                                case 5:
                                    dbAdapter.addCalifTemas(idModulo, 5, 6, score);//asta hay
                                    break;
                                default:
                                    break;
                            }
                    ...
                    timer.cancel();
//                    dbAdapter.addCalifTemas(score, idModulo, 1, 1);
//-----------------------------------------------------------------------------------------------------
                    Intent intent = new Intent(QuizActivity.this, ResultActivity.class);
                    Bundle b = new Bundle();
                    b.putInt("score", score); //Your score
                    b.putInt("tema", valoresRecibidos.getInt("tema")); //Your score
                    b.putInt("modulo", valoresRecibidos.getInt("modulo")); //Your score
