package utng.edu.mx.proyectoruby2.util;
...
import utng.edu.mx.proyectoruby2.FormLoginActivity;
import utng.edu.mx.proyectoruby2.dao.DBHelper;
import utng.edu.mx.proyectoruby2.model.Modulo;
import utng.edu.mx.proyectoruby2.model.Tema;
...
public class DBAdapter {
    ...
    private void addTemas(int posicionMod,int idModulo){
        ...
        switch (posicionMod){
            case 1:
                tema=new Tema("Modulo1_Tema1",idModulo,true);//Sobre ruby
                addTema(tema);
                tema=new Tema("Modulo1_Tema2",idModulo,false);//Medio ambiente de configuracion
                addTema(tema);
                tema=new Tema("Modulo1_Tema3",idModulo,false);//Sintaxis
                addTema(tema);
                tema=new Tema("Modulo1_Tema4",idModulo,false);//Palabras reservadas
                addTema(tema);
                tema=new Tema("Modulo1_Tema5",idModulo,false);//Variables
                addTema(tema);
                tema=new Tema("Modulo1_Tema6",idModulo,false);//Operadores
                addTema(tema);
                tema=new Tema("Modulo1_Tema7",idModulo,false);//Comentarios
                addTema(tema);
